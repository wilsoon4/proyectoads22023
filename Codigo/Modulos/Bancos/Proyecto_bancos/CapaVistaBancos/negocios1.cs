    ...
    class negocios1
    {
        ...
        public static void ObtenerIdBanco(String noCuenta)
        {
            ...
            if (dtS.Rows.Count > 0)
            {
                ...
                negocios1.nomBanco = nombreBanco;
            }
        }
        ...
        public static void ObtenertMoneda1(String noCuen)
        {
            ...
            {
                DataRow row = dtS.Rows[0];
                negocios1.tMoneda = Convert.ToString(row["fk_cori_tipo_de_moneda"]);
            }
        }
        ...
        public static void ObtenerBancoCuenta(String noCuen)
        {
            ...
            {
                DataRow row = dtS.Rows[0];
                negocios1.banconom = Convert.ToString(row["fk_cori_tipo_de_moneda"]);
            }
        }
        ...
        public static void TraspasoSaldo(String noCuenO, String noCuenD, double saldoO, double saldoD, double traslado)
        {
            ...
            negocios1.ObtenertMoneda1(noCuenO);
            tmonedaO = negocios1.tMoneda;
            negocios1.ObtenertMoneda1(noCuenD);
            tmonedaD = negocios1.tMoneda;
            ...
            else
            {
                ...
                else if ((tmonedaO == "Quetzales" || tmonedaO == "quetzales") && (tmonedaD == "Dolares" || tmonedaD == "dolares"))
                {
                    ...
                    double valor, conver;
                    negocios1.ObtenerValorM(tmonedaD);
                    valor = 7.34;
